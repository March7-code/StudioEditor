...
- Runtime target: imported character models inside Body Editor
- Explicitly excluded from the first version: clothing collision and soft-body simulation

Current foundation slice:

- Added the independent `BodyEditor.Characters` runtime assembly.
...
```text
BodyEditor.Characters
BodyEditor.Characters.Pose
BodyEditor.Characters.Constraints
BodyEditor.Characters.SecondaryPhysics
BodyEditor.Characters.Import
```
...
Assets/BodyEditor/Runtime/Characters/Import/
    ICharacterImporter.cs
    ICharacterBodyProfileProvider.cs

Assets/BodyEditor/Runtime/Legacy/Characters/
    LegacyCharacterModelBridge.cs

Assets/BodyEditor/Adapters/Koikatsu/Characters/
...
- `BodyEditor.Runtime` contains no dependency on a Koikatsu type or assembly.
