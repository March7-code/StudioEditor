...
namespace BodyEditor.Viewport
{
    ...
    internal sealed class BodyEditorViewportInputController
    {
        private readonly BodyEditorViewport viewport;
        ...
        public BodyEditorViewportInputController(
            BodyEditorViewport viewport,
