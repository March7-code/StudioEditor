...
namespace StudioEditor.Viewport
{
    ...
    public sealed class StudioEditorViewport : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            StudioEditorSettings.Changed += HandleEditorSettingsChanged;
        ...
        {
            StudioEditorSettings.ApplyTo(controls);
        }
    }
    ...
    internal sealed class ViewportGrid
    {
        ...
        public ViewportGrid(Transform parent)
        {
            ...
            if (shader == null)
            {
                Debug.LogWarning("Studio Editor viewport grid could not find an unlit shader.");
                return;
            }
