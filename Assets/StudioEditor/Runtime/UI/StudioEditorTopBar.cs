...
namespace StudioEditor.UI
{
    ...
    public sealed class StudioEditorTopBar : MonoBehaviour
    {
        ...
        private StudioEditorViewportInputController inputController;
        ...
        private void OnEnable()
        {
            ...
            viewport = GetComponent<StudioEditorViewport>();
            if (viewport != null)
            {
                inputController = new StudioEditorViewportInputController(
                    viewport,
                    viewport.Controls);
            }
            ...
            ApplyUiScale();
            StudioEditorSettings.Changed += ApplyUiScale;
        ...
        private void ApplyUiScale()
        {
            ...
            {
                panelSettings.scale = StudioEditorSettings.UiScale;
            }
        }
        ...
        private void BuildUi(VisualElement root)
        {
            ...
            uiRoot.RegisterCallback<KeyDownEvent>(
                HandleKeyDown,
                TrickleDown.TrickleDown);
            root.AddToClassList("studio-editor-ui");
            root.RemoveFromClassList(
                "studio-editor-ui--sidebar-collapsed");
            root.pickingMode = PickingMode.Ignore;

            viewportInput = new VisualElement
            {
                name = "studio-editor-viewport-input",
            ...
            {
                name = "studio-editor-workspace-tools",
            ...
            root.Add(new StudioEditorSidebar(
                controller,
        ...
        private async void PickAndImport()
        {
                    ...
                    out var pickerError))
            {
                if (!string.IsNullOrEmpty(pickerError))
                {
                    ...
                    Debug.LogError($"[Studio Editor] {pickerError}", this);
                }
